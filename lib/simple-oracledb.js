...
function SimpleOracleDB() {
    ...
    const monitor = Monitor.create(this);
    ...
    Object.defineProperty(this, 'diagnosticInfo', {
        ...
        get: function getDiagnosticInfo() {
             ...
             * @public
             */
            const diagnosticInfo = monitor.diagnosticInfo;
    ...
    Object.defineProperty(this, 'enableDiagnosticInfo', {
        ...
        get: function isEnabled() {
             ...
             * @public
             */
            const enableDiagnosticInfo = monitor.enabled;
 ...
 * @example
 * ```js
 * const actionRunner = simpleOracleDB.createOnConnectionCallback(function (connection) {
...
SimpleOracleDB.prototype.createOnConnectionCallback = function (action, invocationOptions, releaseOptions, callback) {
    return function onConnection(connectionError, connection) {
        if (connectionError) {
            ...
            try {
                let onActionDone = function (actionAsyncError, result) {
                ...
                const promise = action(connection, onActionDone);
