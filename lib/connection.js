...
Connection.prototype.executeMany = function (sql, bindParamsArray, options, callback) {
    var input = this.getExecuteArguments(sql, bindParamsArray, options, callback);

    sql = input.sql;
    bindParamsArray = input.bindParams;
    options = input.options;
    callback = input.callback;
    ...
    debug('Execute, SQL: ', sql, ' Bind Params Array: ', bindParamsArray);

    var args = [
        sql
    ];
    if (bindParamsArray) {
        args.push(bindParamsArray);
    ...
    return this.baseExecuteMany.apply(this, args);
};
                ...
                if (useExecuteMany) {
                    ...
                    var createTask = function (outBinds, lobExecuteData, rowsAffected) {
                        return function (asyncCallback) {
                            recordWriter.writeMultiple(outBinds, lobExecuteData, function (operationError, operationResults) {
                                /*istanbul ignore else*/
...
Connection.prototype.batchInsertOrUpdate = function (insert, sql, bindParamsArray, options, callback) {
    ...
    options.useExecuteMany = ((options.useExecuteMany || options.useExecuteMany === undefined) && self.executeMany && typeof self.executeMany === 'function');
