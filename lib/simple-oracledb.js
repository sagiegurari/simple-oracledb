    ...
    if (extendArgs.length === 1) {
        ...
        if (oracle.createPool) {
            ...
            oracle.getConnection = function () {
                ...
                return promiseHelper.run(function onPromise(promiseCallback) {
            ...
            oracle.createPool = function () {
                ...
                var createPoolAsync = function (promiseCallback) {
                ...
                return promiseHelper.run(createPoolAsync, callback);
            };
