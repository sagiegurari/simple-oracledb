...
Connection.prototype.insertOrUpdate = function (insert, sql, bindParams, options, callback) {
    ...
    var useExecuteMany = (options && options.useExecuteMany && (constants.features.executeManySupport || options.forceUseExecuteMany) && self.executeMany && typeof self.executeMany === 'function');
    if (useExecuteMany) {
