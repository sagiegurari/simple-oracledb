...
function SimpleOracleDB() {
    ...
    Object.defineProperty(this, 'enableStats', {
        /**
         * Getter for the stats enabled flag.
         *
         * @function
         * @memberof! Info
         * @private
         * @returns {boolean} The stats enabled flag
         */
        get: function isEnabled() {
             ...
             * @memberof! SimpleOracleDB
             * @member {boolean}
             * @alias SimpleOracleDB.enableStats
             * @public
             */
            var enableStats = monitor.enabled;

            return enableStats;
        },
        /**
         * Setter for the stats enabled flag.
         *
         * @function
         * @memberof! Info
         * @private
         * @param {boolean} value - The stats enabled flag
         */
